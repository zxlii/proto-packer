...
namespace WS.Data {
  ...
  public static partial class DataPaymentReflection {
    ...
    static DataPaymentReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            "ChFEYXRhUGF5bWVudC5wcm90bxIHV1MuRGF0YSJ6CgtEYXRhUGF5bWVudBIK",
            "CgJpZBgBIAEoBRIVCg1kZWZpbml0aW9uX2lkGAIgASgJEhEKCWFkZF9tb25l",
            "eRgDIAEoBRIRCgl0b29sc190aXAYBCABKAUSFAoMdG9vbHNfcHV6emxlGAUg",
            "ASgFEgwKBGNhc3QYBiABKAJiBnByb3RvMw=="));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          new pbr::FileDescriptor[] { },
          new pbr::GeneratedClrTypeInfo(null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::WS.Data.DataPayment), global::WS.Data.DataPayment.Parser, new[]{ "Id", "DefinitionId", "AddMoney", "ToolsTip", "ToolsPuzzle", "Cast" }, null, null, null)
          }));
    }
    #endregion
  ...
  public sealed partial class DataPayment : pb::IMessage<DataPayment> {
    ...
    /// <summary>Field number for the "add_money" field.</summary>
    ...
    /// <summary>Field number for the "tools_tip" field.</summary>
    ...
    /// <summary>Field number for the "tools_puzzle" field.</summary>
    ...
    public const int CastFieldNumber = 6;
    private float cast_;
    /// <summary>
    ///金额
    /// </summary>
    ...
    public override int GetHashCode() {
      ...
      if (Cast != 0F) hash ^= Cast.GetHashCode();
      return hash;
    }
