...
namespace WS.Data {
    ...
    static DataLetterReflection() {
      ...
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::WS.Data.DataLetter), global::WS.Data.DataLetter.Parser, new[]{ "Id", "Letter", "Type", "UnlockLetterId", "HorizentalLinkId", "VerticalLinkId", "PieceId", "PieceIndex" }, null, null, null)
          }));
    }
    #endregion
  ...
  public sealed partial class DataLetter : pb::IMessage<DataLetter> {
    ...
    public DataLetter(DataLetter other) : this() {
      ...
      type_ = other.type_;
      unlockLetterId_ = other.unlockLetterId_;
    ...
    /// <summary>Field number for the "unlockLetterId" field.</summary>
    public const int UnlockLetterIdFieldNumber = 4;
    private int unlockLetterId_;
    /// <summary>
    ///触发解锁单词的第一个块
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public int UnlockLetterId {
      get { return unlockLetterId_; }
      set {
        unlockLetterId_ = value;
      }
    }
    ...
    public bool Equals(DataLetter other) {
      ...
      if (UnlockLetterId != other.UnlockLetterId) return false;
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (UnlockLetterId != 0) {
        ...
        output.WriteInt32(UnlockLetterId);
      }
    ...
    public int CalculateSize() {
      ...
      if (UnlockLetterId != 0) {
        size += 1 + pb::CodedOutputStream.ComputeInt32Size(UnlockLetterId);
      }
      if (HorizentalLinkId != 0) {
    ...
    public void MergeFrom(DataLetter other) {
      ...
      if (other.UnlockLetterId != 0) {
        UnlockLetterId = other.UnlockLetterId;
      }
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 32: {
            UnlockLetterId = input.ReadInt32();
            break;
          }
          case 40: {
